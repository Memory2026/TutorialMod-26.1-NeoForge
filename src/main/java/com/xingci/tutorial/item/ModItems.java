...
import com.xingci.tutorial.item.custom.PickaxeAxeItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> PICKAXE_AXE_ITEM =
            ITEMS.registerItem("pickaxe_axe_item",
                    p -> new PickaxeAxeItem(ModToolMaterials.FIRE_ETHER,
                            5.0F, -2.4F, p));
